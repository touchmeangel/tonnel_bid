...
func main() {
	...
	for {
		...
		for gf := range ch {
			...
			msg := fmt.Sprintf("<a href=\"%s\">%s #%d</a>\n\nBid Cost: <b>%f</b> %s\nMin Sell: <b>%f</b> %s\nProfit: <b>%f</b>%% (%f %s)\n%sEnd in: %02d:%02d:%02d\n\n<b><a href=\"https://t.me/portals/market?startapp=r6tctl\">Portal</a></b> | <b><a href=\"https://t.me/tonnel_network_bot/gifts?startapp=ref_8302952344\">Tonnel</a></b>", link, gf.Gift.Name, gf.Gift.GiftNum, bid, gf.Gift.Asset, gf.Floor, gf.Gift.Asset, profitPercentage*100, gf.Floor-bid, gf.Gift.Asset, portalMsg, hours, minutes, seconds)
