...
func main() {
	...
	for {
		...
		for gf := range ch {
			...
			msg := fmt.Sprintf("<b>%s</b> <code>#%d</code>\n\nBid Cost: <b>%f</b> %s\nMin Sell: <b>%f</b> %s\nProfit: <b>%f</b>%% (%f %s)\nEnd in: %02d:%02d:%02d\n\n<a href=\"https://t.me/tonnel_network_bot/gift?startapp=%d\">Link</a>", gf.Gift.Name, gf.Gift.GiftNum, bid, gf.Gift.Asset, gf.Floor, gf.Gift.Asset, profitPercentage*100, gf.Floor-bid, gf.Gift.Asset, hours, minutes, seconds, gf.Gift.GiftID)
